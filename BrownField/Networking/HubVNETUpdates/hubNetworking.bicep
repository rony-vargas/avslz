...
param parCompanyPrefix string = 'caflzpp'
...
param parAzBastionNsgName string = 'AzureBastionSubnet-nsg'
...
module modBastionPublicIp './modules/publicIp/publicIp.bicep' = if (parAzBastionEnabled) {
